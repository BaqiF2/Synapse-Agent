...
```
You (1)> 请搜索包含 "test" 关键词的技能
```

**预期行为**:
- Agent 执行 skill search "test"
- 返回 test-skill 技能信息
...
```
You (2)> 请读取 test-skill 的 SKILL.md 文档
```
...
```
You (3)> 请执行 skill:test-skill:hello Synapse
```
...
```
You (4)> 执行 skill:test-skill:hello -h
```
