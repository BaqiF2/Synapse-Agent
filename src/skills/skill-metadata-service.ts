 ...
 * 从 SkillManager 中提取，用于打破 skill-command-handler 与 skill-manager 之间的循环依赖。
 *
 * 核心导出：
...
import type { SkillMeta, VersionInfo } from './types.js';
 ...
 * 技能元数据只读查询接口
 *
 * 用于解耦 skill-command-handler 对 SkillManager 的直接依赖
 */
