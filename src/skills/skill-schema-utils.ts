/**
 * Skill Schema Utils - SKILL.md 解析工具函数
 *
 * 包含 frontmatter 解析、引号剥离、section 规范化、key-value/section 内容解析。
 *
 * @module skill-schema-utils
 * Core Exports:
 * - extractFrontmatter / applyFrontmatter / normalizeSection / setKeyValue / parseSectionContent / PATTERNS
 */

import { SKILL_DOMAINS, type SkillDomain, type SkillDoc } from './skill-schema.ts';
