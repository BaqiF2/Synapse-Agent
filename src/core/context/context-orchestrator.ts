...
import { parseEnvPositiveInt, parseEnvScanRatio, parseEnvOptionalString } from '../../shared/env.ts';
...
export class ContextOrchestrator {
  ...
  private ensureContextCompactor(offloadSessionDir: string): ContextCompactor | null {
    ...
    if (!this.contextCompactor) {
      const storage = new OffloadStorage(offloadSessionDir);
      this.contextCompactor = new ContextCompactor(storage, this.client, this.generateFn, {
