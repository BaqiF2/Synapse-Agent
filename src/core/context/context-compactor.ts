...
import type { GenerateFunction } from '../../types/generate.ts';
import type { Message } from '../../types/message.ts';
import { createTextMessage, extractText } from '../../shared/message-utils.ts';
...
export class ContextCompactor {
  constructor(
    ...
    private readonly generateFn?: GenerateFunction,
  ...
  private async resolveGenerateFn(): Promise<GenerateFunction> {
    if (this.generateFn) return this.generateFn;
